...
def test_pressure_gain_from_water_height():
   ...
   assert pressure_gain_from_water_height(30.0) == approx(295.628, abs=0.001)
...
def test_pressure_loss_from_pipe():
    ...
    assert pressure_loss_from_pipe(0.286870,1800.75,0.013,1.55)==approx(-110.884, abs=0.001)
